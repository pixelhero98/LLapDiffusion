...
from tools.llapdiff_checkpoint_eval import _load_stack
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--data-root",
        type=str,
        default=str(PROJECT_ROOT / "ldt" / "synthetic_data" / "synthetic_regime"),
        help="Root directory for generated synthetic caches.",
    )
    parser.add_argument(
        "--output-root",
        type=str,
        default=str(PROJECT_ROOT / "ldt" / "results" / "synthetic_regime"),
        help="Root directory for synthetic metric tables.",
    )
    parser.add_argument(
        "--artifact-root",
        type=str,
        default=str(PROJECT_ROOT / "ldt" / "synthetic_artifacts"),
...
def _evaluate_checkpoint(
    ...
    sampling = tv._sampling_kwargs(cfg, prefix="TEST", fallback_prefix="EVAL")
